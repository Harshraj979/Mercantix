...
import { AuthTokenResponse } from '@mercantix/contracts';
    ...
    <div className="max-w-md mx-auto py-12">
      <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
        <div className="text-center space-y-1">
          <h1 className="text-2xl font-black text-slate-900">Sign in to Mercantix</h1>
          <p className="text-sm text-slate-500">Access your orders, addresses, and wishlist</p>
        </div>
